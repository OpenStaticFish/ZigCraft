...
const DrawState = struct {
    current_texture: rhi.TextureHandle = 0,
    current_normal_texture: rhi.TextureHandle = 0,
    current_roughness_texture: rhi.TextureHandle = 0,
    current_displacement_texture: rhi.TextureHandle = 0,
    current_env_texture: rhi.TextureHandle = 0,
    current_water_reflection_texture: rhi.TextureHandle = 0,
    current_scene_depth_texture: rhi.TextureHandle = 0,
    current_lpv_texture: rhi.TextureHandle = 0,
    current_lpv_texture_g: rhi.TextureHandle = 0,
    current_lpv_texture_b: rhi.TextureHandle = 0,
    dummy_texture: rhi.TextureHandle = 0,
    dummy_texture_3d: rhi.TextureHandle = 0,
    dummy_normal_texture: rhi.TextureHandle = 0,
    dummy_roughness_texture: rhi.TextureHandle = 0,
    bound_texture: rhi.TextureHandle = 0,
    bound_normal_texture: rhi.TextureHandle = 0,
    bound_roughness_texture: rhi.TextureHandle = 0,
    bound_displacement_texture: rhi.TextureHandle = 0,
    bound_env_texture: rhi.TextureHandle = 0,
    bound_water_reflection_texture: rhi.TextureHandle = 0,
    bound_scene_depth_texture: rhi.TextureHandle = 0,
    bound_lpv_texture: rhi.TextureHandle = 0,
    bound_lpv_texture_g: rhi.TextureHandle = 0,
    bound_lpv_texture_b: rhi.TextureHandle = 0,
    bound_ssao_handle: rhi.TextureHandle = 0,
    bound_shadow_views: [rhi.SHADOW_CASCADE_COUNT]c.VkImageView = .{null} ** rhi.SHADOW_CASCADE_COUNT,
    descriptors_dirty: [MAX_FRAMES_IN_FLIGHT]bool = .{true} ** MAX_FRAMES_IN_FLIGHT,
...
const RuntimeState = struct {
    ...
    lpv_recorded_this_frame: bool = false,
    lpv_abort_generation: u64 = 0,
...
const TimingState = struct {
    ...
    timing_results: rhi.GpuTimingResults = std.mem.zeroes(rhi.GpuTimingResults),
...
pub const VulkanContext = struct {
    init_ownership: @import("rhi_init_deinit.zig").InitOwnership = .{},
